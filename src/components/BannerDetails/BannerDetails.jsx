          ...
          <div className="grid grid-cols-1 items-center gap-4  md:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Tech Global Private Limited is a business pioneer in providing
                innovative, rich and highly effective Business, Technology &
                communication solutions to meet the Business, IT & Marketing
                requirements of our clients. Our solutions have succeeded in
                gaining attention of some of the well-known National and
